/* eslint-disable @typescript-eslint/no-magic-numbers, @typescript-eslint/ban-ts-comment, sonarjs/function-return-type, @cspell/spellchecker */
// Disabled rules rationale: vendored port of sun.js from the solar-calc library (see comment below).
// - no-magic-numbers: algorithm constants from the original source, not domain values
// - sonarjs/function-return-type: JS-era inconsistent returns intrinsic to the algorithm
// - @cspell/spellchecker: mathematical abbreviations (mrad, sinm, julianday) are algorithm symbols
// @ts-nocheck
